...
class Venustheme_TreeMenu_Block_List extends Mage_Core_Block_Template {
    ...
    public function __construct($attributes = array()) {
        $helper = Mage::helper('venustheme_treemenu/data');
        ...
        $mediaHelper->addMediaFile("skin_css", "venustheme_treemenu/" . $this->_theme . "/style.css");
        parent::__construct();
    }
 /**
    ...
    function _toHtml() {
		...
		/* Assign html */
        $theme = ($this->getConfig('theme') != "") ? $this->getConfig('theme') : "default";
        $this->_config['template'] = 'venustheme/treemenu/' . $theme . '/default.phtml';
        // render html
    ...
    function set($params) {
        ...
        if ($theme != $this->_theme) {
            $mediaHelper = Mage::helper('venustheme_treemenu/media');
            $mediaHelper->addMediaFile("skin_css", "venustheme_treemenu/" . $theme . "/style.css");
        }
    }
    ...
    public function buildThumbnail($imageArray, $twidth, $theight) {
        ...
        if ($thumbnailMode != 'none') {
            $imageProcessor = Mage::helper('venustheme_treemenu/venusthemeimage');
