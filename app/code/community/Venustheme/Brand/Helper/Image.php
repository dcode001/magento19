...
class Venustheme_Brand_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('venustheme_brand/banner_image'));
     ...
     *
     * @see venustheme_brand_Model_Banner_Image
     * @param int $width
     * @param int $height
     * @return venustheme_brand_Helper_Image
     */
     ...
     * Enter description here...
     *
     * @return venustheme_brand_Model_Banner_Image
     */
