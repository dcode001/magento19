...
class Venustheme_ProductScroll_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('venustheme_productscroll/banner_image'));
     ...
     *
     * @see venustheme_productscroll_Model_Banner_Image
     * @param int $width
     * @param int $height
     * @return venustheme_productscroll_Helper_Image
     */
     ...
     * Enter description here...
     *
     * @return venustheme_productscroll_Model_Banner_Image
     */
