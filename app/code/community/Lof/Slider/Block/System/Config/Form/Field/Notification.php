 ...
 */
class Lof_Slider_Block_System_Config_Form_Field_Notification extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
		
		$url  = Mage::getBaseUrl('js');
		$jspath = $url.'lof_slider/form/script.js';
		$csspath = $url.'lof_slider/form/style.css';
