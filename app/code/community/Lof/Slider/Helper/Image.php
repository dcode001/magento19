 ...
 */
class Lof_Slider_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('lof_slider/banner_image'));
     ...
     *
     * @see Lof_Slider_Model_Banner_Image
     * @param int $width
     * @param int $height
     * @return Lof_Slider_Helper_Image
     */
     ...
     * Enter description here...
     *
     * @return Lof_Slider_Model_Banner_Image
     */
